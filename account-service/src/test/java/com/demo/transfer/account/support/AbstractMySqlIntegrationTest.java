 ...
 * 从而保证测试看到的 {@code DECIMAL(32,8)}、唯一索引、约束与生产相同。
 *
 * <p>account-service 的实体映射 {@code account_a} 库结构，故连接 {@code account_a}；
 * 因初始化脚本以 root 创建多库，测试亦以 root 连接以获得跨库表访问权限。
 */
@ActiveProfiles("test")
public abstract class AbstractMySqlIntegrationTest {
    ...
    private static final String TARGET_DATABASE = "account_a";
    ...
    static void registerDatasource(DynamicPropertyRegistry registry) {
        ...
        // 初始化脚本以 root 建多库，故以 root 访问 account_a 的表
